...
This lesson has been tested with the following versions: MarcEdit 7 (specifically 7.6.3 and 7.7.10) for Windows and MarcEdit 3.5 for MacOS. It should be highlighted that MarcEdit is frequently updated with minor changes. It is recommended that the latest version is used, but note that this may mean there are minor differences between the current version and the versions used to test this lesson. 

#### About Downloading Plug-Ins and Packages

Extra functionality is available as add-ons called packages or plug-ins, which are not in the out of the box set up. Packages and plug-ins, along with associated system requirements, are available from [MarcEdit Downloads](https://marcedit.reeset.net/downloads) for Windows and MacOS. For this lesson, you do not need to download any packages or plug-ins.
...
For additional information, consult [System requirements for MarcEdit 7/MarcEdit Windows](https://marcedit.reeset.net/downloads).

#### Determining if your system is 32 or 64-bit
In the Start menu, type in About to get About Your PC. In Device Specifications, the system type will tell you if it is a 32 or 64-bit CPU.

#### Installing MarcEdit - [Video](https://www.youtube.com/watch?v=FX0r7jIxeN4)
...
For additional information, consult [System requirements for MarcEdit 7/MarcEdit MacOS 3x](https://marcedit.reeset.net/downloads).

:::::::::::::::::::::::::::::::::::::: instructor

Note: For Mac, the MarcEdit installation does not require the user to check for a 32 or 64-bit CPU.
  
:::::::::::::::::::::::::::::::::::::::::::::::::

#### Installing MarcEdit - [Video](https://www.youtube.com/watch?v=m8TQsNhpw8I)

This link ["MacOs"](https://marcedit.reeset.net/software/marcedit75/MarcEdit3_5.pkg.zip) will directly download the zip installation for MarcEdit MacOS 3x. Once downloaded, unzip the package and follow the MacOS instructions for the MacOS 3x. 

:::::::::::::::::::::::::::::::::::::: instructor

Note: There is a version 7.7 for MAC which requires using the Terminal. This is not covered in this lesson but can be highlighted for those with more knowledge of Mac and Mac's terminal. For more assistance with Mac installations, consult the [Mac Installation Instructions](https://marcedit.reeset.net/marcedit-mac-installation-instructions) or the [Running MarcEdit 7.7 on a Mac](https://www.youtube.com/watch?v=jgkYJEfcZY0).
...
- MarcEdit Data Settings
  - My MARC Format is: Select MARC 21
  - Default Recording Encoding: Select MARC 21/UTF8
...
-  Go to [this link](https://github.com/LibraryCarpentry/lc-marcedit/blob/main/episodes/data/marc_sample_data.mrc) to download the sample data file from GitHub
...
For this lesson, you need to download our sample file from the Library Carpentries MarcEdit GitHub repository. This MARC file follows the MARC 21 standard and is encoded in UTF-8. 

The sample file comes from MARC 21 records downloaded from the Open Textbook Library and the University of Florida's original catalog data. "Open Textbook Library records are in the public domain and available under a Creative Commons CC0 license." [Open Textbook Library](https://open.umn.edu/opentextbooks/discovery). 

The book catalog in MARC 21 format from the University of Florida has been released in the public domain under a CC0 license. [Creative Commons](https://wiki.creativecommons.org/wiki/CC0_use_for_data#University_of_Florida_Library)
...
Installation video demonstrations are available for all users. Go to [this link][https://youtu.be/FX0r7jIxeN4](https://youtu.be/FX0r7jIxeN4) to view the YouTube video.

If you encounter problems installing or running MarcEdit, a good source of support is the [MarcEdit mailing list and user forum](https://listserv.gmu.edu/cgi-bin/wa?A0=marcedit-l). The mailing list requires you to subscribe to the list to be able to read content and post. To view the archive, you will also need to create a login account. You can also fill out the [Help Form](https://marcedit.reeset.net/contact-me). Include your operating system when searching to find the most relevant answers for your issue.

You may also want to check these [Videos](https://www.youtube.com/playlist?list=PLrHRsJ91nVFScJLS91SWR5awtFfpewMWg) or the [MarcEdit Knowledge Base](https://marcedit.reeset.net/archives/category/knowledge_base) for answers to your questions or to seek help.
